                ...
                <tbody>
                    @foreach ($details as $detail)
                        <tr>
                            <td> {{ $detail->name }}</td>
                            <td width="200"> 
                                <a href="{{ route('detail.plan.edit', [$plan->url, $detail->id] )}}" class="btn btn-info">Editar</a>

                                <a href="{{ route('detail.plan.show', [ $plan->url, $detail->id])}}" class="btn btn-warning">Ver</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
